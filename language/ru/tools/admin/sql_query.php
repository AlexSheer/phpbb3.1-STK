...
$lang = array_merge($lang, array(
	...
	'SQL_QUERY_EXPLAIN'				=> 'Введите SQL-запрос, который вы желаете выполнить.<br />Если в запрсе вы укажете префикс <b>phpbb_</b>, но используете другой, то он будет заменен на ваш префикс таблиц базы данных.<br />Если установлен флажек &laquo;<u>Отобразить результаты</u>&raquo;, инструмент покажет результаты <em>(если таковые имеются)</em> выполнения запроса.',
