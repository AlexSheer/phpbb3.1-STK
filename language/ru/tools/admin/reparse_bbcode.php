...
$lang = array_merge($lang, array(
	...
	'REPARSE_BBCODE_CONFIRM'		=> 'Вы уверены, что хотите провести репарсинг всех BBCode? Учтите, что это средство потенциально может повредить информацию в базе данных, поэтому <strong>убедитесь, что имеете резервную копию базы данных прежде, чем начнете процесс</strong>. Кроме того, учтите, что это действие может занять значительное время.',
