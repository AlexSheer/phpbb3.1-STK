...
$lang = array_merge($lang, array(
	...
	'CLICK_TO_CLEAR'				=> 'Записи об выбранных установленных расширениях будут удалены из базы данных и расширения отключены, однако данные, относящиеся к этим расширениям, такие как таблицы или значения конфигурации, останутся. Для их удаления воспользуйтесь <b>ИНСТРУМЕНТЫ ПОДДЕРЖКИ</b> --> Проверка изменений в Базе Данных',
	'CLICK_TO_OFF'					=> 'Выбранные расширения будут отключены',
	'OFF_EXT'						=> 'Отключить',
