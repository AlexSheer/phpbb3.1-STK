...
$lang = array_merge($lang, array(
	...
	'MYSQL_UPGRADER_BACKUP'				=> 'Этот инструмент потенциально опасен. Убедитесь в том, что имеете резервную копию вашей Базы данных! Без необходимых знаний об обновлении MySQL запускать не рекомендуется!',
	'MYSQL_UPGRADER_EXPLAIN'			=> 'Этот инструмент предназначен для решения проблем, которые возникают из-за несовместимости версии MySQL с вашей версией phpBB, а также после обновления версии MySQL на более новую. Инструмент укажет на несовместимые таблицы Базы Данных с версией phpBB <em> Смотрите также “<a href="http://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors" target="_blank" />Есть\нет ошибки</a>” в таблицах Базы Данных.</em>',
