...
/**
 *
 * @package Support Toolkit - Flash checker Russian language Pthelovod
...
$lang = array_merge($lang, array(
	...
	'FLASH_CHECKER_FOUND'		=> 'Контролёр flash обнаружил потенциально опасносные flash BBcode на вашей конференции. Нажмите <a href="%s">здесь</a> для репарсинга сообщений и личных сообщений, содержащих flash BBCode.',
