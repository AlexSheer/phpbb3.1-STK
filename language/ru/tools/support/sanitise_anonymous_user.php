...
/**
*
* @package Support Toolkit - Anonymous group check Russian language Pthelovod
* @version $Id$
...
$lang = array_merge($lang, array(
	...
	'ANONYMOUS_CREATION_FAILED'			=> 'Невозможно пересоздать учётную запись гостя. Запросите поддержку на официальном сайте поддержки phpBB.com',
	...
	'ANONYMOUS_WRONG_GROUPS_CONFIRM'	=> 'Учётная запись Гостя принадлежит к нескольким группам, что не правильно. Вы хотите удалить Гостя из всех групп, кроме группы ГОСТИ?',
