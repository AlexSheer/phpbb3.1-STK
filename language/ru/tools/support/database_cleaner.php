...
$lang = array_merge($lang, array(
	...
	'DATABASE_CLEANER_EXTRA'		=> 'Обнаружены дополнительные элементы, добавленные при модификацях. <strong>Все отмеченные элементы будут удалены. Если вы уверены в необходимости их оставить - снимите метки с тех, которые необходимо оставить </strong>.',
	'DATABASE_CLEANER_MISSING'		=> 'Любые поля на красном фоне должны быть добавлены. Они должны быть в стандартной конфигурации конференции и их отсутствие невозможно. Их необходимо восстановить. <strong>Если оставить или установить отметки в найденных полях на красной фоне, то выбранные поля будут добавлены</strong>.',
	'DATABASE_CLEANER_SUCCESS'		=> 'Инструмент Проверки Базы Данных успешно завершил работу!<br /><br />При возникших проблеммах в работе конференции восстановитесь из резервной копии вашей Базы Данных.',
	...
	'EMPTY_PREFIX'					=> 'Неправильный префикс',
	...
	'FINAL_STEP'					=> 'Это завершающий шаг.<br /><br />Сейчас необходимо перейти на вашу конференцию и очистить кеш.',
	...
	'RESET_REPORT_REASONS_EXPLAIN'	=> 'Хотите очистить все журналы  форума одновременно? Это очистит все журналы без возможности восстановления!',
	...
	'SECTION_NOT_CHANGED_EXPLAIN'	=> array(
		...
		'final_step'				=> 'После этого этапа нужно очистить кеш и можно запустить проверку еще раз.',
	),
	'SUCCESS'						=> 'Успешно',
