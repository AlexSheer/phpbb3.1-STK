...
$lang = array_merge($lang, array(
	...
	'DAMAGED_POSTS_EXPLAIN'						=> 'Следующие идентификаторы сообщений относятся к несуществующим пользователям. Пожалуйста, посетите <a href="https://www.phpbb.com/community/viewforum.php?f=46">поддержку форумов</a> для получения помощи в решении этой проблемы.',
