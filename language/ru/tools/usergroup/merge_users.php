...
/**
*
* @package Support Toolkit - Merge Users Russian language Pthelovod
* @version $Id$
...
$lang = array_merge($lang, array(
	'MERGE_USERS'							=> 'Объединение пользователей между собой',
	'MERGE_USERS_EXPLAIN'					=> 'Инструмент объединит права и все темы с сообщениями с одной пользовательской учётной записи в другую учётную запись (установки исходного пользователя и его членство в группах - остаются). Переносятся (добавляются) права доступа, вложения, блокировки, закладки, черновики, записи о просмотрах форумов/тем, история посещений, голосование, сообщения, личные сообщения, жалобы, темы, предупреждения, записи о друзьях и недругах.',

	'MERGE_USERS_BOTH_FOUNDERS'				=> 'Вы не можете объединить основателя с не основателем.',
