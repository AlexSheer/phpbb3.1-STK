...
$lang = array_merge($lang, array(
	'SRT_QUESTIONS_EXPLAIN'	=> array(
		'step2'	=> array(
			...
			'board_url'			=> 'URL конференции - это адрес, который вы используете для доступа к вашей конференции. Большинство проблем легче исправить, если можно получить доступ к вашей уонференции. Если вы не хотите сообщать эту информацию, введите "n/a".',
