...
$lang = array_merge($lang, array(
	...
	'MBSTRING_LOADED'	=> 'Функции для работы с многобайтными строками (расширение php <strong>mbstring</strong>) загружены',
	'MBSTRING_NOT_LOADED'				=> 'Функции для работы с многобайтными строками (расширение php <strong>mbstring</strong>) не загружены',
