...
$lang = array_merge($lang, array(
	...
	'CAT_USERGROUP_EXPLAIN'				=> 'Средства пользователя/группы могут быть использованы для управления пользователями и группами, такими способами, которые не доступны в стандартной установке phpBB 3.1.x.',
	...
	'REQUEST_PHPBB_VERSION_EXPLAIN'		=> 'Инструментарий поддержки не смог определить версию вашей конференции, пожалуйста выберите ее из представленного списка.<br />Сделайте визит на <a href="http://www.phpbb.com/community/viewforum.php?f=46">форум поддержки</a> чтобы получить корректную помощь в решении данной проблемы.',
