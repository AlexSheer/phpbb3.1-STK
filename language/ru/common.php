...
$lang = array_merge($lang, array(
	...
	'REQUEST_PHPBB_VERSION_EXPLAIN'		=> 'Инструментарий поддержки не смог определить версию вашей конференции, пожалуйста выберите ее из представленного списка.<br />Посетите <a href="http://www.phpbbguru.net/community/forum47.html">форум поддержки</a> чтобы получить конкретную помощь в решении данной проблемы.',
