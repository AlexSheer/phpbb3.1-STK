...
$lang = array_merge($lang, array(
	...
	'CAT_MAIN'							=> 'Главная',
	'CAT_MAIN_EXPLAIN'					=> 'Инструментарий поддержки (или Support Toolkit, или STK), представляет собой программный пакет, который может быть использован для устранения проблем, связанных с работой phpBB 3.1.x. Инструментарий является второй <b>Администраторской панелью управления</b>, предоставляющей администратору доступ к инструментам, используемым для разрешения различных проблем неправильного функционирования конференции.',
