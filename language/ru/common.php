...
$lang = array_merge($lang, array(
	...
	'CAT_USERGROUP_EXPLAIN'				=> 'Средства пользователей и групп могут быть использованы для управления пользователями и группами, такими способами, которые не доступны в стандартной установке phpBB 3.1.x.',
	...
	'STK_INCOMPATIBLE'				=> 'Эта версия STK для phpBB версии 3.1.x, в то время как ваша версия %1$s',
));
