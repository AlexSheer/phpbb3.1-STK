...
$lang = array_merge($lang, array(
	...
	'SELECT_ALL'						=> 'Pour sélectionner tout, déplacer le curseur dans le champ ci-dessous et appuyez sur Ctrl-A (PC), Cmd-A (Mac) <br />Double clic sélectionne un mot et triple rangée entière.'
));
