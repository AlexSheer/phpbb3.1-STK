			...
			case BBCODE_REPARSE_POSTS :
				$sql_ary = array(
					'SELECT'	=> 'f.forum_id, f.enable_indexing,
									...
									t.topic_id, t.topic_first_post_id, t.topic_last_post_id, t.topic_type, t.topic_status, t.topic_title, t.poll_title, t.topic_time_limit, t.poll_start, t.poll_length, t.poll_max_options, t.poll_last_vote, t.poll_vote_change,
									u.username',
					'FROM'		=> array(
						FORUMS_TABLE	=> 'f',
						POSTS_TABLE		=> 'p',
