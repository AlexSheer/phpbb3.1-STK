...
/**
* phpBB 3.1.7-pl1 data file
*/
class datafile_3_1_7_pl1
{
	/**
	* @var Array The bots
	*/
	var $bots = array(
		// No bot changes 3.1.7 -> 3.1.7-pl1
	);

	/**
	* @var Array 3.1.7-pl1 config data
	*/
	var $config = array(
		// No config changes 3.1.7 -> 3.1.7-pl1
	);

	/**
	* @var Array Config entries that were removed by the 3.1.7-pl1 update
	*/
	var $removed_config = array(
		// No config entries removed 3.1.7 -> 3.1.7-pl1
	);
	...
	*/
	var $acl_options = array(
		// No permission changes 3.1.7 -> 3.1.7-pl1
	);
	...
	*/
	var $acl_roles = array(
		// No role changes 3.1.7 -> 3.1.7-pl1
	);
	...
	*/
	var $acl_role_data = array(
		// No role data changes 3.1.7 -> 3.1.7-pl1
	);
	...
	*/
	var $extension_groups = array(
		// No extension group changes 3.1.7 -> 3.1.7-pl1
	);
	...
	*/
	var $extensions = array(
		// No extension changes 3.1.7 -> 3.1.7-pl1
	);
	...
	*/
	...
	{
		// No schema changes 3.1.7 -> 3.1.7-pl1
	}
}
