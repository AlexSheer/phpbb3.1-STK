...
/**
* phpBB 3.1.3 data file
*/
class datafile_3_1_3
{
	/**
	* @var Array The bots
	*/
	var $bots = array(
		// No bots changes 3.1.2 -> 3.1.3
	);

	/**
	* @var Array 3.1.3 config data
	*/
	var $config = array(
		// No config changes 3.1.2 -> 3.1.3
	);

	/**
	* @var Array Config entries that were removed by the 3.1.3 update
	*/
	var $removed_config = array(
		// No config entries removed 3.1.2 -> 3.1.3
	);
	...
	*/
	var $acl_options = array(
		// No permission changes 3.1.2 -> 3.1.3
	);
	...
	*/
	var $acl_role_data = array(
		// No role data changes 3.1.2 -> 3.1.3
	);
	...
	*/
	var $extension_groups = array(
		// No extension group changes 3.1.2 -> 3.1.3
	);
	...
	*/
	var $extensions = array(
		// No extension changes 3.1.2 -> 3.1.3
	);
	...
	*/
	var $groups = array(
		// No Group changes 3.1.2 -> 3.1.3
	);
	/**
	* @var Array All default report reasons
	*/
	var $report_reasons = array(
		// No reason changes 3.1.2 -> 3.1.3
	);

	var $acp_modules = array(
		// No ACP modules changes 3.1.2 -> 3.1.3
	);
